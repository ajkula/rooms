...
class Decision {
  ...
  rooting(tree = this.tree) {
    ...
    if (tree[0].label !== "leaf" && tree[0].label  !== "root") {
      if ((this.enemy.inventory[tree[0].label] >= tree[0][tree[0].label]) || ( this.enemy[tree[0].label] >= tree[0][tree[0].label])) { console.log(this.enemy.inventory[tree[0].label], tree[0][tree[0].label]); this.rooting(tree[0].actions) }
